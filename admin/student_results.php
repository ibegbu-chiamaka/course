<?php
// Student Results Page (admin/student_results.php)
session_start();
...
// Fetch students who have results
$query = "SELECT DISTINCT s.student_id, s.matric_no, s.full_name, s.department, s.level 
          FROM results r 
...
<table>
    ...
    <?php while ($row = $result->fetch_assoc()) { ?>
        <tr>
            ...
            <td>
                <a href="view_result.php?student_id=<?php echo $row['student_id']; ?>">View</a> |
                <a href="delete_result.php?student_id=<?php echo $row['student_id']; ?>" onclick="return confirm('Are you sure you want to delete this result?');">Delete</a>
            </td>
        </tr>
    <?php } ?>
</table>
